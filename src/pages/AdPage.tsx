    ...
    <div>
        ...
        <div className="flex justify-center">
          <div className="grid grid-rows-2 grid-cols-1 h-screen">
            <div className="grid grid-cols-3 grid-rows-1 h-full gap-2">
              <img src={currentAd?.img1} className="block w-full border border-secondary h-full rounded" alt="img1" />
              <img src={currentAd?.img2} className="block w-full border border-secondary rounded h-full object-cover" alt="img2" />
              <img src={currentAd?.img3} className="block w-full border border-secondary h-full rounded object-cover" alt="img3" />
            </div>
                ...
                <div className="flex items-center text-center border border-secondary rounded-md w-96 h-40 ml-auto mt-10">
                  ...
                  <span className="grid grid-rows-2 w-64">
                    ...
                    <div className="flex items-center text-center w-auto h-9">
                      ...
                      <span className="text-primary-darker text-base">{parseFloat(currentAd?.userrep!.toString()!).toFixed(2).toString()}</span>
                    </div>
                  </span>
                </div>
              </div>
      ...
      {isProposalModalOpen && (
        <ProposalModal
          ...
          sellerName={currentAd?.user || "Vendedor"}
          productPrice={currentAd?.price || 0}
        />
      )}
    </div>
  );
